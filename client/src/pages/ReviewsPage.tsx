            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  {!previewUrl ? (
                    <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-primary-500 transition-colors cursor-pointer relative">
                      <input
                        type="file"
                        accept="image/*"
                    ...
                    <div className="relative w-full max-w-xs rounded-xl overflow-hidden shadow-md group">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-primary-600 text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
